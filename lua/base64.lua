local DEFAULT_INDEX_TABLE = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'
...
base64.to = function(to_encode, index_table)
    index_table = index_table or DEFAULT_INDEX_TABLE
    local bit_pattern = ''
    local encoded = ''
    local trailing = ''
...
base64.from = function(to_decode, index_table)
    index_table = index_table or DEFAULT_INDEX_TABLE
